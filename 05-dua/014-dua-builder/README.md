...
Build your own dua routine — morning, evening, and occasion-based dua organizer.
...
Building a personal dua routine helps maintain constant connection with Allah throughout the day.

## Technical

- **HS_KEY**: `wdiy-hs-dua-builder`
- **Footer**: Workshop-Diy — Dua Builder v1.0
