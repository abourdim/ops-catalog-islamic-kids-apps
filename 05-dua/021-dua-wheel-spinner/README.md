...
Colorful spinning wheel that lands on occasions, revealing the appropriate dua for each.
...
Learning duas by occasion helps children remember when to use each supplication.

## Technical

- **HS_KEY**: `wdiy-hs-dua-wheel-spinner`
- **Footer**: Workshop-Diy \u2014 Dua Wheel Spinner v1.0
