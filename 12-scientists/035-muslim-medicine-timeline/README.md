# Muslim Medicine Timeline

Timeline of Muslim medical innovations.

## Concept

Interactive educational app about Muslim scientific contributions. Muslim Medicine Timeline (Medecine Musulmane / Timeline).
...
- **HS_KEY**: `wdiy-hs-muslim-medicine-timeline`
- **Footer**: Workshop-Diy — Muslim Medicine Timeline v1.0
