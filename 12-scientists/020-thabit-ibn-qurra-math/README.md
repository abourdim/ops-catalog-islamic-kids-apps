# Thabit Visual Geometry

Explore Thabit ibn Qurra proofs through visual geometry.

## Concept

Interactive educational app about Muslim scientific contributions. Thabit Visual Geometry (Geometrie Thabit / Geometry).
...
- **HS_KEY**: `wdiy-hs-thabit-math`
- **Footer**: Workshop-Diy — Thabit Math v1.0
