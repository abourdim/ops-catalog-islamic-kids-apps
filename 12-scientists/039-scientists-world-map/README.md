# Muslim Scientists World Map

Interactive map of where Muslim scientists worked.

## Concept

Interactive educational app about Muslim scientific contributions. Muslim Scientists World Map (Carte des Savants / Map).
...
- **HS_KEY**: `wdiy-hs-scientists-world-map`
- **Footer**: Workshop-Diy — Scientists Map v1.0
