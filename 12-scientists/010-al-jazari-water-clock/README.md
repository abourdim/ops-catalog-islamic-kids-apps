...
Assemble Al-Jazari elephant water clock.

## Concept

Interactive educational app about Muslim scientific contributions. Elephant Water Clock (Horloge Elephant / Clock).
...
- **HS_KEY**: `wdiy-hs-al-jazari-water-clock`
- **Footer**: Workshop-Diy — Elephant Water Clock v1.0
