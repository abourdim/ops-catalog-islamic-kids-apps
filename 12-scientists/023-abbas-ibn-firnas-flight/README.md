# Abbas ibn Firnas Glider

Design and test the first human glider.

## Concept

Interactive educational app about Muslim scientific contributions. Abbas ibn Firnas Glider (Planeur Ibn Firnas / Flight).
...
- **HS_KEY**: `wdiy-hs-abbas-ibn-firnas-flight`
- **Footer**: Workshop-Diy — Abbas ibn Firnas v1.0
