# Al-Razi Diagnostic Methods

Apply Al-Razi clinical observation to diagnose patients.

## Concept

Interactive educational app about Muslim scientific contributions. Al-Razi Diagnostic Methods (Diagnostics Al-Razi / Diagnosis).
...
- **HS_KEY**: `wdiy-hs-al-razi-medicine`
- **Footer**: Workshop-Diy — Al-Razi Medicine v1.0
