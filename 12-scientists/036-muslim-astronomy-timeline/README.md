# Muslim Astronomy Timeline

Muslim astronomical achievements timeline.

## Concept

Interactive educational app about Muslim scientific contributions. Muslim Astronomy Timeline (Astronomie Musulmane / Timeline).
...
- **HS_KEY**: `wdiy-hs-muslim-astronomy-timeline`
- **Footer**: Workshop-Diy — Muslim Astronomy Timeline v1.0
