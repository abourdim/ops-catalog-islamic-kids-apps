# Al-Razi Smallpox vs Measles

Al-Razi first distinguished smallpox from measles.

## Concept

Interactive educational app about Muslim scientific contributions. Al-Razi Smallpox vs Measles (Variole vs Rougeole / Differential).
...
- **HS_KEY**: `wdiy-hs-al-razi-smallpox`
- **Footer**: Workshop-Diy — Al-Razi Smallpox v1.0
