...
Build a distillation apparatus.

## Concept

Interactive educational app about Muslim scientific contributions. Jabir Distillation (Distillation Jabir / Distillation).
...
- **HS_KEY**: `wdiy-hs-jabir-distillation`
- **Footer**: Workshop-Diy — Jabir Distillation v1.0
