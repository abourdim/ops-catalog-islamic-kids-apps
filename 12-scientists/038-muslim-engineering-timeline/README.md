# Muslim Engineering Timeline

Muslim engineering innovations timeline.

## Concept

Interactive educational app about Muslim scientific contributions. Muslim Engineering Timeline (Ingenierie Musulmane / Timeline).
...
- Interactive hands-on educational experience
- High score persistence via localStorage

## Technical

- **HS_KEY**: `wdiy-hs-muslim-engineering-timeline`
- **Footer**: Workshop-Diy — Muslim Engineering Timeline v1.0
