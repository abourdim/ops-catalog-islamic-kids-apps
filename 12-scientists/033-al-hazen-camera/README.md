# Build Camera Obscura

Build the camera obscura with Ibn al-Haytham.

## Concept

Interactive educational app about Muslim scientific contributions. Build Camera Obscura (Camera Obscura / Camera).
...
- **HS_KEY**: `wdiy-hs-al-hazen-camera`
- **Footer**: Workshop-Diy — Camera Obscura v1.0
